...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-a7536c57');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-a7536c57');}
...
var brandEl=document.querySelector('.rl-brand-a7536c57');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
